...
export default function UploadZone({ onSubmit, error }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[500px] h-full px-6">
        ...
        <div className="grid grid-cols-3 gap-3 w-full pt-1">
          {[
            { 
              ...
              label: 'Segmentation', desc: 'Automated vessel mapping',
            },
            {
              ...
              label: 'AI Analysis', desc: 'Automated clinical summary',
            },
            {
              ...
              label: '3D Viewer', desc: 'Interactive scan review',
            },
          ].map(({ label, desc, icon }) => (
            <div 
              key={label}
            ...
            >
              ...
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold tracking-widest text-white">{label}</p>
